...
#ifndef __OMPLETEPACKETSTARTSTART_H
#define __OMPLETEPACKETSTARTSTART_H
...
class CompletePacketStartStart : public cSimpleModule
{
  protected:
    double bitrate = 0;
    int cutthroughBitLength = 0;
    CompletePacketStartStart *cutthroughModule = nullptr;
  ...
  public:
    virtual ~CompletePacketStartStart();
