...
class SIM_API cSimpleModule : public cModule //implies noncopyable
{
  ...
  protected:
     ...
     */
    virtual void sendCompletePacketAtStart(cPacket *packet, cGate *gate, simtime_t duration);
    /**
     * Packet ownership is transferred.
     */
    virtual void sendCompletePacketAtEnd(cPacket *packet, cGate *gate, simtime_t duration);

    /**
     * Packet ownership is transferred.
     */
    virtual void receiveCompletePacketAtStart(cPacket *packet) { throw cRuntimeError("Invalid operation"); }
    /**
     * Packet ownership is transferred.
     */
    virtual void receiveCompletePacketAtEnd(cPacket *packet) { throw cRuntimeError("Invalid operation"); }

    /**
     * Packet ownership is not transferred, packet is not modified.
     */
    virtual void sendPacketStart(cPacket *packet, cGate *gate, simtime_t delay, simtime_t duration, double datarate);
    /**
     * Packet ownership is not transferred, packet is not modified.
     *
     ...
     */
    virtual void sendPacketProgress(cPacket *packet, cGate *gate, simtime_t delay, simtime_t duration, double datarate, int bitPosition, simtime_t timePosition, int extraProcessableBitLength = 0, simtime_t extraProcessableDuration = 0);
    /**
     * Packet ownership is transferred.
     */
    virtual void sendPacketEnd(cPacket *packet, cGate *gate, simtime_t delay, simtime_t duration, double datarate);
