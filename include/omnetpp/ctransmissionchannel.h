//==========================================================================
//   CTRANSMISSIONCHANNEL.H  -  header for
//                     OMNeT++/OMNEST
...
#ifndef __OMNETPP_CTRANSMISSIONCHANNEL_H
#define __OMNETPP_CTRANSMISSIONCHANNEL_H
 ...
 * @ingroup SimCore
 */
class SIM_API cTransmissionChannel : public cChannel //implies noncopyable
{
  protected:
  ...
  public:
     ...
     */
    explicit cTransmissionChannel(const char *name=nullptr);

    /**
     * Destructor.
     */
    virtual ~cTransmissionChannel();

    /**
     * Utility function for dynamic channel creation. Equivalent to
     * <tt>cChannelType::getDatarateChannelType()->create(name)</tt>.
     */
    static cTransmissionChannel *create(const char *name);
    //@}
